#!/usr/bin/env python3
"""
Launch RViz visualization for the arap_robot.
...
:author: Addison Sears-Collins (modified for arap_robot)
:date: March 8, 2025
"""
import os
...
def process_ros2_controllers_config(context):
    ...
    src_config_path = os.path.join(
        home,
        'ros2_ws/src/arap_robot/arap_robot_description/config',
        robot_name
    )
    install_config_path = os.path.join(
        home,
        'ros2_ws/install/arap_robot_description/share/arap_robot_description/config',
        robot_name
    )
...
ARGUMENTS = [
    DeclareLaunchArgument('robot_name', default_value='arap_robot',
...
def generate_launch_description():
    ...
    """
    # Define filenames
    urdf_package = 'arap_robot_description'
    urdf_filename = 'arap_robot.urdf.xacro'
    rviz_config_filename = 'arap_robot_description.rviz'
