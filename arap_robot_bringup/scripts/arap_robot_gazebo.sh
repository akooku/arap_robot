#!/bin/bash
# Single script to launch the ARAP Robot with Gazebo and ROS 2 Controllers
...
# Adjust Gazebo camera pose using: 
...
echo "Launching Gazebo simulation for ARAP Robot..."
ros2 launch arap_robot_gazebo arap_robot.gazebo.launch.py \
    enable_odom_tf:=true \
    headless:=False \
