 ...
 * @brief Speed limiter for differential drive velocity components
 *
 * This class provides velocity, acceleration, and jerk limiting functionality
 * for the velocity components (linear and angular) of a 4-wheeled differential drive robot.
 *
 * @author Addison Sears-Collins (modified for differential drive)
 * @date March 9, 2025
 */

 #ifndef DIFFERENTIAL_DRIVE_CONTROLLER__SPEED_LIMITER_HPP_
 #define DIFFERENTIAL_DRIVE_CONTROLLER__SPEED_LIMITER_HPP_
 ...
 #endif  // DIFFERENTIAL_DRIVE_CONTROLLER__SPEED_LIMITER_HPP_ 